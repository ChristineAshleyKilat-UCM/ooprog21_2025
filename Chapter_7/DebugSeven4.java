...
for(int i = 0; i < stringLength; i++) //Fixed  the conditions
{
char ch = Character.toLowerCase(aString.charAt(i)); //Fixed the method calling
System.out.print(ch);
if(Character.isLetter(ch)) //Fixed the condition
numLetters++;
}
System.out.println();
System.out.println
("The number of CHARACTERS in the string is " + stringLength);
System.out.println("The number of LETTERS is "  + numLetters); //Added a closing
}
}
